...
public class TicTacToeFullGame extends JFrame implements ActionListener, MouseListener 
{
    // get Pane
...
//creating grid through nested for-loop 
    ...
    {
        TicTacToeFullGame t = new TicTacToeFullGame();
    }
