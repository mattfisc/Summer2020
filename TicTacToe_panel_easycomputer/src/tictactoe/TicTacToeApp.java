...
public class TicTacToeApp extends JFrame implements ActionListener, MouseListener 
{
    // get Pane
    ...
    Difficulty_Panel difficultyPanel = new Difficulty_Panel();
    ...
    public TicTacToeApp(){
        ...
        // add panel to content
        content.add(score, BorderLayout.WEST);
        content.add(difficultyPanel,BorderLayout.EAST);
        ...
        difficultyPanel.setDifficultyEventListener(new DifficultyListener(){
            @Override
            public void difficultyEventOccurred(DifficultyEvent e) {

                String str = e.getLevel();
                
                // Selected hard computer
                if(str.equals("Hard"))
...
//        board = new Board();
    ...
    public void createWindow(){
        ...
        this.setSize(600,400);// set window size
    ...
    public int[] computerTurn(){
        int[] t = computer.turn(game);
        
        
        System.out.println("computer turn " + t[0] +" " +t[1]);
        // display computer turn
        game[t[0]][t[1]] = 'O';
        grid[t[0]][t[1]].setText("0");
        grid[t[0]][t[1]].setForeground(Color.BLACK);
